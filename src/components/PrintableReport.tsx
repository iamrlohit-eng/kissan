...
export const PrintableReport = forwardRef<HTMLDivElement, PrintableReportProps>(
  ({ fieldName, location, reportDate, analysis, reportData, detectedLanguage }, ref) => {
      ...
      >
        ...
        <div className="flex items-center justify-between border-b-2 border-green-600 pb-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-green-800">KISAAN - Soil Analysis Report</h1>
        ...
        <div className="bg-green-50 rounded-lg p-4 mb-6">
          <h2 className="text-lg font-bold text-green-800 mb-2 flex items-center gap-2">
            <MapPin className="w-5 h-5" /> Field Information
          </h2>
          <div className="grid grid-cols-3 gap-4 text-sm">
            <div>
              <span className="font-semibold">Field Name:</span> {fieldName}
            </div>
            <div>
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="font-semibold">Report Date:</span> {new Date(reportDate).toLocaleDateString()}
            </div>
          </div>
        </div>
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-2 text-center">
                  {reportData.nitrogen ?? analysis.extractedData?.nitrogen ?? "N/A"} ppm
                </td>
              ...
              <tr className="bg-gray-50">
                ...
                <td className="border border-gray-300 p-2 text-center">
                  {reportData.phosphorus ?? analysis.extractedData?.phosphorus ?? "N/A"} ppm
                </td>
                <td className="border border-gray-300 p-2 text-center capitalize">
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-2 text-center">
                  {reportData.potassium ?? analysis.extractedData?.potassium ?? "N/A"} ppm
                </td>
                <td className="border border-gray-300 p-2 text-center capitalize">
              ...
              <tr className="bg-gray-50">
                ...
                <td className="border border-gray-300 p-2 text-center">
                  {reportData.ph ?? analysis.extractedData?.ph ?? "N/A"}
                </td>
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-2 text-center">
                  {reportData.organicMatter ?? analysis.extractedData?.organicMatter ?? "N/A"}%
                </td>
                <td className="border border-gray-300 p-2 text-center" colSpan={2}>
                  {reportData.organicMatter
                    ? reportData.organicMatter < 3
                      ? "Low - Add compost or organic matter"
                      : reportData.organicMatter > 5
              ...
              <tr className="bg-gray-50">
                ...
                <td className="border border-gray-300 p-2 text-center">
                  {reportData.moisture ?? analysis.extractedData?.moisture ?? "N/A"}%
                </td>
                <td className="border border-gray-300 p-2 text-center" colSpan={2}>
                  {reportData.moisture
                    ? reportData.moisture < 20
                      ? "Dry - Irrigation recommended"
                      : reportData.moisture > 60
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              {analysis.improvementTechniques.map((technique, i) => (
                <div key={i} className="bg-gray-50 rounded-lg p-3 border-l-4" style={{ borderColor: priorityColors[technique.priority] || "#22c55e" }}>
